...
const Footer = () => {
  const GitHubIcon = () => (
    <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" className="inline mr-2">
  ...
  return (
    <footer className="mt-auto text-center pt-8 border-t border-bg-tertiary text-text-tertiary">
      <p className="mb-4">&copy; 2025 Renekris. Infrastructure & Development Solutions.</p>
